...
<table cellpadding="12" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td  width="70%" align="left"><span>Được quyền tuyển dụng không giới hạn số lượng SM/FC trên khắp các tỉnh thành toàn quốc.</span></td>
    </tr>
    <tr>
...
<table cellpadding="7" cellspacing="0" border="1">
    <tr>
        ...
        <td class="bold" width="50%" align="center" ><span>YÊU CẦU</span><br><span>(3 tháng đầu tiên)</span></td>
    </tr>
    <tr>
        <td width="50%" align="center">Giám đốc kinh doanh – SD</td>
        <td width="50%" align="center">Tổng nhân sự là 4 thành viên đạt chuẩn
Hoặc >= 60 triệu P.FYP tháng đầu tiên
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="center" ><span class="font-12 bold">CƠ CHẾ THÙ LAO DÀNH CHO GIÁM ĐỐC KHU VỰC</span></td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập của Giám đốc khu vực (SD)</b> gồm những khoản sau:
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b> Thu nhập 1: </b>Từ bán cá nhân là <b>50% P.FYP</b>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b> Thu nhập 2:</b> Từ quản lý trực tiếp toàn hệ thống của SM (Cấp 2)
            </span>
            <br>
            <table cellpadding="10" cellspacing="0" border="1">
                <tr>
                    <td width="100%" align="center" >
                        <span>
                            Thu nhập = 10% x Tổng P.FYP toàn hệ thống FC báo cáo trực tiếp SD
                        </span>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td width="100%" align="left" >
            <span>
                <b> Thu nhập 3:</b> Từ quản lý trực tiếp toàn hệ thống của FC (Cấp 1)
            </span>
            <br>
            <table cellpadding="10" cellspacing="0" border="1">
                <tr>
                    <td width="100%" align="center" >
                        <span>
                            Thu nhập = 20% x Tổng P.FYP toàn hệ thống FC báo cáo trực tiếp SD
                        </span>
                    </td>
                </tr>
            </table>
...
<table cellpadding="3" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 4:</b> Từ phí tái tục năm thứ hai của hợp đồng bảo hiểm nhân thọ
            </span>
        </td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 5: Gói hỗ trợ khởi nghiệp</b>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
            - Gói hỗ trợ khởi nghiệp dành cho SD là: <strong>120 triệu</strong>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
            - Cấp SD sẽ nhận được gói hỗ trợ khởi nghiệp tương ứng nếu đạt chỉ tiêu theo
...
<table border="1">  
    ...
    <tr>
        ...
        <td align="center">{{number_format($p_fyp)}}</td>
        <td align="center">{{number_format($p_fyp)}}</td>
        <td align="center">6,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 2</td>
        <td align="center">{{number_format($p_fyp + 20000000)}} </td>
        <td align="center">{{number_format($p_fyp + 20000000 + $p_fyp)}}</td>
        <td align="center">8,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 3</td>
        <td align="center">{{number_format($p_fyp + 40000000)}}  </td>
        <td align="center">{{number_format($p_fyp + 20000000 + $p_fyp + 40000000)}}</td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 4</td>
        <td align="center">{{number_format($p_fyp + 50000000)}} </td>
        <td align="center">350,000,000  </td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 5</td>
        <td align="center">{{number_format($p_fyp + 60000000)}}</td>
        <td align="center">470,000,000</td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 6</td>
        <td align="center">{{number_format($p_fyp + 70000000)}} </td>
        <td align="center">     600,000,000  </td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 7</td>
        <td align="center">{{number_format($p_fyp + 80000000)}}</td>
        <td align="center">     740,000,000 </td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 8</td>
        <td align="center">{{number_format($p_fyp + 80000000)}}</td>
        <td align="center">     880,000,000  </td>
        <td align="center">10,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 9</td>
        <td align="center">{{number_format($p_fyp + 80000000)}} </td>
        <td align="center"> 1,020,000,000 </td>
        <td align="center">11,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 10</td>
        <td align="center">{{number_format($p_fyp + 100000000)}}</td>
        <td align="center"> 1,180,000,000 </td>
        <td align="center">11,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 11</td>
        <td align="center">1{{number_format($p_fyp + 100000000)}} </td>
        <td align="center"> 1,340,000,000  </td>
        <td align="center">12,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 12</td>
        <td align="center">{{number_format($p_fyp + 100000000)}} </td>
        <td align="center">1,500,000,000</td>
        <td align="center">12,000,000</td>
    </tr>
    <tr>
        <td align="center"><strong>TỔNG</strong></td>
        <td align="center"><strong>1,500,000,000</strong></td>
        <td align="center"><strong>1,500,000,000</strong></td>
        <td align="center"><strong>120,000,000</strong></td>
    </tr>      
</table>
<br>
<table cellpadding="3" cellspacing="0" border="0">
