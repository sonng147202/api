...
<table cellpadding="12" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td  width="70%" align="left"><span>Ban giám đốc công ty</span></td>
    </tr>
    <tr>
        <td width="30%" align="left"><span>Phạm vi tuyển dụng:</span></td>
        <td  width="70%" align="left"><span>Được quyền tuyển dụng không giới hạn số lượng SRD, RD, SD, SM, FC trên khắp các tỉnh thành toàn quốc.</span></td>
    </tr>
    <tr>
...
<table cellpadding="5" cellspacing="0" border="0">
    ...
    <tr>
        <td align="left">
            Trong 6 tháng đầu tiên {{ $sex }} cần hoàn thành các chỉ tiêu tối thiểu về số lượng thành viên đạt chuẩn hoặc doanh số tháng đầu tiên của gói hỗ trợ khởi nghiệp như sau:
        </td>
    </tr>
</table>
<table cellpadding="7" cellspacing="0" border="1">
    <tr>
        ...
        <td class="bold" width="50%" align="center" ><span>YÊU CẦU</span><br><span>(6 tháng đầu tiên)</span></td>
    </tr>
    <tr>
        <td width="50%" align="center">Giám đốc miền – TD</td>
        <td width="50%" align="center">Tổng nhân sự là 32 thành viên đạt chuẩn
Hoặc >= 500 triệu P.FYP tháng đầu tiên
...
<table cellpadding="7" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="left">
            <span>
                3.	Thư mời hợp tác kinh doanh chỉ có hiệu lực khi có chữ ký của người có thẩm quyền của Medici và có giá trị trong vòng 15 ngày kể từ ngày Công ty ra thông báo.
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="center" ><span class="font-12 bold">CƠ CHẾ THÙ LAO DÀNH CHO GIÁM ĐỐC MIỀN</span></td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập dành cho Giám đốc miền (TD)</b> gồm những khoản sau:
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 1: </b>Từ bán cá nhân là <b>70% P.FYP</b>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 2:</b> Từ quản lý trực tiếp toàn hệ thống của SRD (Cấp 5)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="6" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
            Thu nhập = 5% x Tổng P.FYP toàn hệ thống SRD trực tiếp báo cáo TD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="6" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 3:</b> Từ quản lý trực tiếp toàn hệ thống của RD  (Cấp 4)
            </span>
        </td>
    </tr>
</table>
<table cellpadding="6" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 18% x Tổng P.FYP toàn hệ thống RD trực tiếp báo cáo TD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="6" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 4:</b> Từ quản lý trực tiếp toàn hệ thống của SD (Cấp 3)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="6" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
            Thu nhập = 20% x Tổng P.FYP toàn hệ thống SD trực tiếp báo cáo TD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="6" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 5:</b> Từ quản lý trực tiếp toàn hệ thống của SM (Cấp 2)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="5" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
            Thu nhập = 30% x Tổng P.FYP toàn hệ thống SM báo cáo trực tiếp TD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="6" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 6:</b> Từ quản lý trực tiếp toàn hệ thống của FC (Cấp 1)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="6" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 40% x Tổng P.FYP toàn hệ thống FC báo cáo trực tiếp TD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="3" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 7:</b> Từ phí tái tục năm thứ hai của hợp đồng bảo hiểm nhân thọ
            </span>
        </td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 7: Gói hỗ trợ khởi nghiệp</b>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
            - Gói hỗ trợ khởi nghiệp dành cho TD là: <strong>480 triệu</strong>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
            - Cấp TD sẽ nhận được gói hỗ trợ khởi nghiệp tương ứng nếu đạt chỉ tiêu theo
...
<table border="1">  
    <tr>
        ...
        <th rowspan="2" align="center"><strong>Hỗ trợ hàng tháng</strong></th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="center">636,000,000</td>
        <td align="center">1,136,000,000</td>
        <td align="center">35,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 3</td>
        <td align="center">744,000,000</td>
        <td align="center">1,880,000,000</td>
        <td align="center">40,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 4</td>
        <td align="center">840,000,000 </td>
        <td align="center">2,720,000,000</td>
        <td align="center">40,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 5</td>
        <td align="center">924,000,000</td>
        <td align="center">3,644,000,000</td>
        <td align="center">40,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 6</td>
        <td align="center">1,008,000,000</td>
        <td align="center">4,652,000,000</td>
        <td align="center">40,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 7</td>
        <td align="center">1,080,000,000 </td>
        <td align="center">5,732,000,000</td>
        <td align="center">40,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 8</td>
        <td align="center">1,140,000,000</td>
        <td align="center">5,732,000,000</td>
    ...
    <tr>
        ...
        <td align="center">8,072,000,000</td>
        <td align="center">42,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 10</td>
        <td align="center">1,260,000,000</td>
        <td align="center">9,332,000,000</td>
        <td align="center">43,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 11</td>
        <td align="center">1,320,000,000</td>
        <td align="center">10,652,000,000</td>
        <td align="center">44,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 12</td>
        <td align="center">1,348,000,000</td>
        <td align="center">12,000,000,000</td>
        <td align="center">45,000,000</td>
    </tr>
    <tr>
        <td align="center"><strong>TỔNG</strong></td>
        <td align="center"><strong>12,000,000,000</strong></td>
        <td align="center"><strong>12,000,000,000</strong></td>
        <td align="center"><strong>480,000,000</strong></td>
    </tr>      
</table>
<br>
<table cellpadding="3" cellspacing="0" border="0">
