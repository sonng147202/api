...
<table cellpadding="12" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td  width="70%" align="left"><span>Được quyền tuyển dụng không giới hạn số lượng RD, SD, SM, FC trên khắp các tỉnh thành toàn quốc.</span></td>
    </tr>
    <tr>
...
<table cellpadding="7" cellspacing="0" border="1">
    <tr>
        ...
        <td class="bold" width="50%" align="center" ><span>YÊU CẦU</span><br><span>(5 tháng đầu tiên)</span></td>
    </tr>
    <tr>
        <td width="50%" align="center">Giám đốc vùng cấp cao – SRD</td>
        <td width="50%" align="center">Tổng nhân sự là 16 thành viên đạt chuẩn
Hoặc >= 250 triệu P.FYP tháng đầu tiên
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="center" ><span class="font-12 bold">CƠ CHẾ THÙ LAO DÀNH CHO GIÁM ĐỐC VÙNG CẤP CAO</span></td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập của Giám đốc vùng cấp cao (SRD)</b> gồm những khoản sau:
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 1: </b>Từ bán cá nhân là <b>65% P.FYP</b>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
                <b> 2.5.2.Thu nhập 2:</b> Từ quản lý trực tiếp toàn hệ thống của RD (Cấp 4)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="10" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 7% x Tổng P.FYP toàn hệ thống RD trực tiếp báo cáo SRD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="10" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b> 2.5.3. Thu nhập 3:</b> Từ quản lý trực tiếp toàn hệ thống của SD  (Cấp 3)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="10" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 15% x Tổng P.FYP toàn hệ thống SD báo cáo trực tiếp SRD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="10" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>2.4.4. Thu nhập 4</b> Từ quản lý trực tiếp toàn hệ thống của SM (Cấp 2)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="10" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 25% x Tổng P.FYP toàn hệ thống SM báo cáo trực tiếp SRD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="10" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>2.5.5. Thu nhập 5</b> Từ quản lý trực tiếp toàn hệ thống của FC (Cấp 1)
            </span>
        </td>
    </tr>
</table>
...
<table cellpadding="10" cellspacing="0" border="1">
    <tr>
        <td width="100%" align="center" >
            <span>
                Thu nhập = 35% x Tổng P.FYP toàn hệ thống FC báo cáo trực tiếp SRD
            </span>
        </td>
    </tr>
</table>
<table cellpadding="3" cellspacing="0" border="0">
    <tr>
        <td width="100%" align="left" >
            <span>
                <b>Thu nhập 6:</b> Từ phí tái tục năm thứ hai của hợp đồng bảo hiểm nhân thọ
            </span>
        </td>
    </tr>
    <tr>
...
<table cellpadding="3" cellspacing="0" border="0">
    ...
    <tr>
        <td width="100%" align="left" >
            <span>
            - Gói hỗ trợ khởi nghiệp dành cho SRD  là: <strong>360 triệu</strong>
            </span>
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" >
            <span>
            - Cấp SRD  sẽ nhận được gói hỗ trợ khởi nghiệp tương ứng nếu đạt chỉ tiêu theo
...
<table border="1">  
    ...
    <tr>
        ...
        <td align="center">318,000,000</td>
        <td align="center">568,000,000 </td>
        <td align="center">25,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 3</td>
        <td align="center">372,000,000</td>
        <td align="center">940,000,000</td>
        <td align="center">30,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 4</td>
        <td align="center">420,000,000 </td>
        <td align="center">1,360,000,000</td>
        <td align="center">30,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 5</td>
        <td align="center">462,000,000</td>
        <td align="center">1,822,000,000</td>
        <td align="center">30,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 6</td>
        <td align="center">504,000,000</td>
        <td align="center">2,326,000,000</td>
        <td align="center">30,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 7</td>
        <td align="center">540,000,000 </td>
        <td align="center">2,866,000,000</td>
        <td align="center">30,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 8</td>
        <td align="center">570,000,000</td>
        <td align="center">3,436,000,000 </td>
        <td align="center">31,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 9</td>
        <td align="center">600,000,000  </td>
        <td align="center">4,036,000,000</td>
        <td align="center">32,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 10</td>
        <td align="center">630,000,000</td>
        <td align="center">4,666,000,000</td>
        <td align="center">33,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 11</td>
        <td align="center">660,000,000 </td>
        <td align="center">5,326,000,000</td>
        <td align="center">34,000,000</td>
    </tr>
    <tr>
        <td align="center">Tháng thứ 12</td>
        <td align="center">674,000,000</td>
        <td align="center">6,000,000,000</td>
        <td align="center">35,000,000</td>
    </tr>
    <tr>
        <td align="center"><strong>TỔNG</strong></td>
        <td align="center"><strong>6,000,000,000</strong></td>
        <td align="center"><strong>6,000,000,000</strong></td>
        <td align="center"><strong>360,000,000</strong></td>
    </tr>      
</table>
<br>
<table cellpadding="3" cellspacing="0" border="0">
