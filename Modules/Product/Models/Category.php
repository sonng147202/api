...
class Category extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Product\Models\InsuranceType', 'insurance_type_id');
    }

    public function parent_category()
    {
        return $this->belongsTo('Modules\Product\Models\Category', 'parent_id');
    }

    public function children()
    {
        return $this->hasMany('Modules\Product\Models\Category', 'parent_id');
    }

    public function attributes()
    {
        return $this->hasMany('Modules\Product\Models\CategoryAttribute', 'category_id');
    }
}
